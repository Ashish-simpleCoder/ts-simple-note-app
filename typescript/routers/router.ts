...
import { changeNoteColor } from '../controllers/notes/changeNoteColor'
...
router.route('/api/user/note/color/:note_id').patch(changeNoteColor)        //just for creating one note
